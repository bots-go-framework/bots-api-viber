...
const (
	ffj_t_Callbackbase = iota
	ffj_t_Callbackno_such_key

	ffj_t_Callback_Event

	ffj_t_Callback_Timestamp
)

var ffj_key_Callback_Event = []byte("event")

var ffj_key_Callback_Timestamp = []byte("timestamp")
...
mainparse:
	for {
		...
		case fflib.FFParse_want_key:
			...
			if len(kn) <= 0 {
				// "" case. hrm.
				currentKey = ffj_t_Callbackno_such_key
				...
				case 'e':
					...
					if bytes.Equal(ffj_key_Callback_Event, kn) {
						currentKey = ffj_t_Callback_Event
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 't':
					...
					if bytes.Equal(ffj_key_Callback_Timestamp, kn) {
						currentKey = ffj_t_Callback_Timestamp
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				if fflib.EqualFoldRight(ffj_key_Callback_Timestamp, kn) {
					currentKey = ffj_t_Callback_Timestamp
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.SimpleLetterEqualFold(ffj_key_Callback_Event, kn) {
					currentKey = ffj_t_Callback_Event
					state = fflib.FFParse_want_colon
					goto mainparse
				}
		...
		case fflib.FFParse_want_value:
			...
			if tok == fflib.FFTok_left_brace || tok == fflib.FFTok_left_bracket || tok == fflib.FFTok_integer || tok == fflib.FFTok_double || tok == fflib.FFTok_string || tok == fflib.FFTok_bool || tok == fflib.FFTok_null {
				...
				case ffj_t_Callback_Event:
					goto handle_Event

				case ffj_t_Callback_Timestamp:
					goto handle_Timestamp

				case ffj_t_Callbackno_such_key:
